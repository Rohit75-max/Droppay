            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                <div className="flex items-center gap-2 text-[#10B981] mb-1">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.3em]">Technical Uplink</span>
                </div>
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onClose(); }}>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-[9px] font-black uppercase text-slate-500 ml-2">Identify Name</label>
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-black uppercase text-slate-500 ml-2">Streamer Handle</label>
              ...
              <div className="space-y-2">
                <label className="text-[9px] font-black uppercase text-slate-500 ml-2">Transmission Details</label>
                <textarea rows="4" placeholder="Describe your architecture requirements..." className={`w-full p-4 rounded-xl border text-sm outline-none font-medium italic resize-none ${theme === 'dark' ? 'bg-white/5 border-white/10 text-white focus:border-[#10B981]' : 'bg-slate-50 border-slate-200 focus:border-[#10B981]'}`} />
              </div>
